...
export function isValidMuscleGroup(muscleGroup: string): muscleGroup is MuscleGroup {
...
export function isValidTrackingType(trackingType: string): trackingType is TrackingType {
