 ...
 * requests and checks for a valid JWT token and valid user details. Throws
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * This method is called once per request to filter the incoming HTTP
     * request. It checks for a valid JWT token. It then retrieves the user's
     * email from the token's claims and loads user details. If the token is
     * valid and user details are found, it sets the authentication in the
